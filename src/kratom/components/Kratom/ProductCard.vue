...
const oldPrice = computed(() => props.product?.oldPrice ?? props.product?.old_price ?? null)
    ...
    <div class="kratom-product-card__body">
      ...
      <div class="kratom-product-card__footer">
        <div class="kratom-product-card__price">
          <simple-price v-if="oldPrice" :value="oldPrice" class="kratom-product-card__old-price" />
          <simple-price :value="product.price" :currency-code="product.currency" class="kratom-product-card__current-price" />
        </div>
