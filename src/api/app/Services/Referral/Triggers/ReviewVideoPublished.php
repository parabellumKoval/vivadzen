...
class ReviewVideoPublished implements ReferralTrigger
{
    public static function alias(): string { return 'review.published.video'; }
    public static function label(): string { return 'Опубликованный видео отзыв'; }
    public static function description(): ?string { return 'Фикс-начисление за видео отзыв'; }
