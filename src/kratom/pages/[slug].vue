...
const {
  ...
  async () => {
    ...
    if (response.error.value || !response.data.value?.data) {
...
const oldPrice = computed(() => product.value?.oldPrice ?? product.value?.old_price ?? null)
      ...
      <section class="kratom-product-hero">
        ...
        <div class="kratom-product-summary">
          ...
          <div class="kratom-product-summary__pricing">
            <simple-price v-if="oldPrice" :value="oldPrice" class="kratom-product-summary__old-price" />
            <simple-price :value="product?.price" :currency-code="product?.currency" class="kratom-product-summary__price" />
          </div>
          ...
          <div class="kratom-product-summary__buy-box">
            ...
            <button type="button" class="button primary kratom-product-summary__buy-btn" @click="addToCart">
              ...
              <IconCSS name="mynaui:shopping-cart-solid" />
            </button>
          </div>
        </div>
      </section>
...
:deep(.kratom-product-summary__old-price .value) { opacity: 0.4; text-decoration: line-through; }
