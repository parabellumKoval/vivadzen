...
class CrudPanel
{
    ...
    /**
     * Cached CSS stacks pushed from column views for the current response.
     *
     * @var array<string, array{hash: string, content: string}>
     */
    protected $listColumnStyleStacks = [];
    ...
    /**
     * Store a CSS stack snippet generated by a column view.
     *
     * @param  string  $content
     */
    public function recordListColumnStyleStack($content)
    {
        ...
        $hash = md5($content);
        $this->listColumnStyleStacks[$hash] = [
            'hash' => $hash,
            'content' => $content,
        ];
    }
    ...
    /**
     * Retrieve and clear the CSS stacks registered by columns.
     *
     * @return array<int, array{hash: string, content: string}>
     */
    public function pullListColumnStyleStacks()
    {
        $stacks = array_values($this->listColumnStyleStacks);
        $this->listColumnStyleStacks = [];
