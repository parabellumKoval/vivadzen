  ...
  >
    <template v-slot:icon-right>
      <button @click="showHandler" :class="{active: isVisible}" clickable class="show-password">
        <IconCSS v-if="isVisible" name="fluent:eye-off-24-regular" size="24px" class="icon"></IconCSS>
        <IconCSS v-else name="fluent:eye-24-regular" size="24px" class="icon"></IconCSS>
      </button>
    </template>
