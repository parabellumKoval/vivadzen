...
return [
  ...
  'landing_promo' => [
    'subject' => 'Ваш промокод для покупки в магазині Vivadzen',
    'title' => 'Промокод для покупки в магазині',
    'intro' => 'Дякуємо за заявку! Використайте цей промокод при покупці в магазині.',
    'code_label' => 'Ваш промокод',
    'code_hint' => 'Покажіть цей код продавцю під час покупки.',
    'button' => 'Перейти на сайт',
  ],

  'verify_email' => [
    'subject' => 'Підтвердіть адресу електронної пошти',
    'greeting' => 'Добро пожалувати!',
    'intro' => 'Будь ласка, натисніть кнопку нижче, щоб підтвердити адресу своєї електронної пошти.',
    'button' => 'Підтвердити електронну пошту',
    'outro' => 'Якщо ви не створювали акаунт, проігноруйте цей лист.',
  ],
];
